...
public class Creeper extends WalkingMonster implements EntityExplosive {
    ...
    public boolean onUpdate(int currentTick) {
        ...
        Boolean AI = namedTag.getBoolean("AI");
        //if (!AI) return true;
        if(wait)return true;
        wait = true;
        getServer().getScheduler().scheduleTask(new CreeperAsync(this, currentTick - this.lastUpdate, currentTick));
