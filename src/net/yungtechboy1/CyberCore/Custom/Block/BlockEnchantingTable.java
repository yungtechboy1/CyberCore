...
public class BlockEnchantingTable extends BlockTransparent {
    ...
    public boolean onActivate(Item item, Player player) {
        if (player != null) {
            ...
            player.sendMessage("OPENING ENCHANT!!!!!");
            player.addWindow(new net.yungtechboy1.CyberCore.Custom.Inventory.EnchantInventory(this.getLocation()), Player.ENCHANT_WINDOW_ID);
