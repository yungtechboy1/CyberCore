...
//            System.out.println("Power Called THE ACTUAL TICK");
    ...
    public Power.Stage getStage() {
        return Power.Stage.getStageFromInt((int) Math.floor(Level / 20));
    }
    ...
    public enum Stage {
        ...
        public static Power.Stage getStageFromInt(int i) {
            if (i < values().length) {
                return values()[i];
            }
            return null;
