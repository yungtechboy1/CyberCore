package net.yungtechboy1.CyberCore.Manager.LeaderBoard.map;
                ...
                return new ObjectIterator<Entry<V>>() {
                    ...
                    public Entry<V> next() {
                        if ( !this.hasNext() ) {
                            ...
                            entry.key = Long2ObjectArrayMap.this.key[this.curr = this.next];
                            entry.value = (V) Long2ObjectArrayMap.this.value[this.next++];
                            return entry;
                        }
                    }
