...
import net.yungtechboy1.CyberCore.Manager.LeaderBoard.map.Long2ObjectArrayMap;
import net.yungtechboy1.CyberCore.Manager.LeaderBoard.network.packet.RemoveObjectivePacket;
import net.yungtechboy1.CyberCore.Manager.LeaderBoard.network.packet.SetObjectivePacket;
import net.yungtechboy1.CyberCore.Manager.LeaderBoard.network.packet.SetScorePacket;
...
public class Scoreboard {
    ...
    private Long2ObjectArrayMap<ScoreboardLine> scoreboardLines = new Long2ObjectArrayMap<>();
    ...
    public void removeDisplay(DisplaySlot slot) {
        ScoreboardDisplay display = displays.remove(slot);
        if (display != null) {
