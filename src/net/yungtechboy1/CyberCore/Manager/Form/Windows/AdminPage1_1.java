...
public class AdminPage1_1 extends CyberFormSimple {
    public AdminPage1_1() {
        this(new ArrayList());
    }

    public AdminPage1_1(List<ElementButton> buttons) {
        super(FormType.MainForm.Admin_Page_1_1, "CyberFactions | Admin Page 1_1 ","", buttons);
    ...
    public void onRun(CorePlayer cp) {
        ...
        switch (id) {
            case 0:
                cp.showFormWindow(new AdminPage1());
                break;
            case 1:
