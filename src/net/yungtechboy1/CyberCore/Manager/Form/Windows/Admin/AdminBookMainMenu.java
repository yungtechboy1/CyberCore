...
import net.yungtechboy1.CyberCore.Manager.Form.Windows.Admin.Crate.AdminCrateGetCrateKey;
import net.yungtechboy1.CyberCore.Manager.Form.Windows.Admin.Crate.AdminCrateKeyCreator;

public class AdminBookMainMenu  extends CyberFormSimple {
    public AdminBookMainMenu() {
        super(FormType.MainForm.Admin_Main_Book, "Admin > Book Admin Page");
        addButton(new ElementButton("Change Stage Level"));//0//TODO - LATER
    ...
    public boolean onRun(CorePlayer p) {
        ...
        switch (getResponse().getClickedButtonId()) {
            ...
            case 0:
                ...
                if (!h.isNull()) {
                    p.showFormWindow(new AdminBookEditWindow(h));
                }
                break;
            case 1:
                CyberCoreMain.getInstance().CrateMain.PrimedPlayer.add(p.getName());
