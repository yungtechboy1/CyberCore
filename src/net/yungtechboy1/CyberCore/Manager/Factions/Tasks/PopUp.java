...
import main.java.CyberFactions.CustomFloatingTextParticle;
 ...
 */
public class PopUp extends PluginTask<FactionsMain>{
    public int Age = 0;
    public String Text = "";
    public long Eid = 0;
    ...
    public PopUp(FactionsMain main,Player target,Long eid,Level level){
        this(main,target,eid,level,0);
    }

    public PopUp(FactionsMain main,Player target,Long eid,Level level,int age)
    {
        super(main);
        Eid = eid;
        Age = age;
